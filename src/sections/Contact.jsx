...
const Contact = () => {
  return (
    <div className='flex md:flex-col items-center justify-center w-full h-fit py-10 md:py-16 bg-slate-50'>
        <div className='justify-center flex flex-col md:flex-row w-full h-fit md:h-full 5xl:w-[1950px]'>
            ...
            <div className='z-20 -mb-20 md:-mb-0 md:z-0 w-full md:w-1/2 h-full flex justify-start md:justify-center items-start'>
                ...
                <img src={Jay} className='max-w-[500px] drop-shadow-xl object-contain md:object-left h-full w-1/2 md:w-full ' />
            ...
            <div className='z-20 -mt-20 md:-mt-0 md:z-0 h-full flex justify-end md:justify-center items-start  w-full md:w-1/2'>
                <img src={Julieta} className='max-w-[500px] drop-shadow-xl object-contain object-right h-full w-1/2 md:w-full ' />
            </div>  
        </div>
    </div>
  )
